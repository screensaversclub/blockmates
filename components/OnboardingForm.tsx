...
import { addUserRecord } from "@/app/welcome/actions";
...
const OnboardingForm: React.FC = () => {
	...
	return (
		<div className="mt-4 p-3 border border-gray-200 rounded-lg shadow-lg">
			<h1 className="text-2xl font-bold mb-4">Onboarding Page</h1>
			<Formik
